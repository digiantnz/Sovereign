    ...
    return {
        ...
        "operations": {
            ...
            "delete_message": {
                "tool": "python3_exec",
                "script": "scripts/imap_check.py",
                "args": ["--command", "delete", "--account", "business"],
                "tier": "HIGH",
                "params": {
                    "uid":       {"type": "str", "required": False, "default": ""},
                    "from_addr": {"type": "str", "required": False, "default": ""},
                    "subject":   {"type": "str", "required": False, "default": ""},
                },
                "returns": "{status, uid, action}",
            },
            "delete_message_personal": {
                "tool": "python3_exec",
                "script": "scripts/imap_check.py",
                "args": ["--command", "delete", "--account", "personal"],
                "tier": "HIGH",
                "params": {
                    "uid":       {"type": "str", "required": False, "default": ""},
                    "from_addr": {"type": "str", "required": False, "default": ""},
            ...
            "move_message": {
                "tool": "python3_exec",
                "script": "scripts/imap_check.py",
                "args": ["--command", "move", "--account", "business"],
                "tier": "MID",
                "params": {
                    "uid":           {"type": "str", "required": False, "default": ""},
                    "from_addr":     {"type": "str", "required": False, "default": ""},
                    "subject":       {"type": "str", "required": False, "default": ""},
                    "target_folder": {"type": "str", "required": True},
                },
                "returns": "{status, uid, action, destination}",
            },
            "move_message_personal": {
                "tool": "python3_exec",
                "script": "scripts/imap_check.py",
                "args": ["--command", "move", "--account", "personal"],
                "tier": "MID",
                "params": {
                    "uid":           {"type": "str", "required": False, "default": ""},
                    "from_addr":     {"type": "str", "required": False, "default": ""},
